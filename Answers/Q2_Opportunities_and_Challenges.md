...
| :--- | :--- | :--- |
| **Smallholder Farmers** (e.g., Tugbok Progressive Coconut Farmers Coop) | **Climate-Adjusted Parametric Micro-Insurance** | Traditional crop insurance is slow and paperwork-heavy. Parametric systems automate payouts based on wind-speed or rain triggers, delivering quick cash within 48 hours to help families rebuild resilience after climate shocks. |
...
1. **Paper-based data collection is often difficult, expensive, and inconsistent**
   * *The Problem*: Most farmers and small merchants record cash transactions in paper ledgers, which field agents must manually compile. This creates inconsistent data and delays underwriting decisions.
2. **Missing Contextual and Subjective Data**
   * *The Problem*: Standard credit engines look strictly at cash balances and repayment histories. They fail to capture qualitative factors such as climate vulnerability (geospatial coordinates) and borrowers' subjective mental stress under debt.
...
* **Alternative & Subjective Data Integration (Addressing Missing Context)**: The platform enriches standard financial profiles with public weather API data, satellite crop-health indicators (NDVI), and qualitative sentiment scores extracted from voice check-ins with loan officers.
